...
/**
 * Gets the white cherry tree feature and its sapling
 *
 * @see SaplingGenerator
 */
public class WhiteCherrySaplingGenerator extends SaplingGenerator {
    /**
    ...
    @Nullable @Override protected RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> getTreeFeature(Random random, boolean bees) {
        return TreeRegistry.WHITE_CHERRY_TREE;
    }
}