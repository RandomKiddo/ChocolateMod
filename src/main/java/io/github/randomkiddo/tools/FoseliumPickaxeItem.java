 ...
 * to provide a constructor for the custom foselium pickaxe item
 *
 * @see PickaxeItem
 */
public class FoseliumPickaxeItem extends PickaxeItem {
    /**
     * Instantiates a new foselium pickaxe item
     ...
     */
    public FoseliumPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
