...
public class ChocolateRegistry {
     ...
     * Dark Chocolate
     */
    public static final Item DARK_CHOCOLATE = new Item(new FabricItemSettings().group(Chocolate.CHOCOLATE_GROUP)
            .food(new FoodComponent.Builder().hunger(3).saturationModifier(5f).snack().build()));
    /**
    ...
    public static void register() {
        ...
        Registry.register(Registry.ITEM, new Identifier("chocolate", "chocolate_dark"), DARK_CHOCOLATE);
