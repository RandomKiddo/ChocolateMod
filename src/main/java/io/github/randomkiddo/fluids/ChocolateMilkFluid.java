...
/**
 * ChocolateMilkFluid, abstract implementation of a flowable fluid in Fabric
 *
 * Overrides:
 * <code>
...
public abstract class ChocolateMilkFluid extends FlowableFluid {
    /**
     * Returns if this fluid matches the chocolate milk type
    ...
    /**
     * Checks if chocolate milk fluid implementation is infinite
     * @return false
     */
    ...
    @Override protected void beforeBreakingBlock(WorldAccess world, BlockPos pos, BlockState state) {
        world.playSound(null, pos, SoundEvents.BLOCK_WATER_AMBIENT, SoundCategory.BLOCKS, 1f, 1f);
    }
     ...
     * @return The value 3
     */
    @Override public int getTickRate(WorldView view) { return 3; }
     ...
     */
    @Override public Fluid getStill() { return FluidRegistry.STILL_CHOCOLATE_MILK; }

    /**
     * Gets the flowing version of this fluid
     * @return Fluid instance that's flowing
     */
    @Override public Fluid getFlowing() { return FluidRegistry.FLOWING_CHOCOLATE_MILK; }

    /**
     * Gets the bucket item for this fluid
     * @return The Item instance of the fluid
     */
    @Override public Item getBucketItem() { return FluidRegistry.CHOCOLATE_MILK_BUCKET; }
    ...
    @Override protected BlockState toBlockState(FluidState fluidState) {
        return FluidRegistry.CHOCOLATE_MILK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }

    /**
     * The subclass that represents the ChocolateMilkFluid as flowing
     */
