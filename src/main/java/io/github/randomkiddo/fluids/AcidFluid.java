...
/**
 * AcidFluid, abstract implementation of a flowable fluid in Fabric
 *
 * Overrides:
 * <code>
...
public abstract class AcidFluid extends FlowableFluid {
    /**
     * Returns if this fluid matches the acid type
    ...
    /**
     * Checks if acid fluid implementation is infinite
     * @return false
     */
     ...
     */
    @Override public Fluid getStill() { return FluidRegistry.STILL_ACID; }

    /**
     * Gets the flowing version of this fluid
     * @return Fluid instance that's flowing
     */
    @Override public Fluid getFlowing() { return FluidRegistry.FLOWING_ACID; }

    /**
     * Gets the bucket item for this fluid
     * @return The Item instance of the fluid
     */
    @Override public Item getBucketItem() { return FluidRegistry.ACID_BUCKET; }
    ...
    @Override protected BlockState toBlockState(FluidState fluidState) {
        return FluidRegistry.ACID.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
